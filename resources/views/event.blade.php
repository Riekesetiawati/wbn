                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="md:w-1/2 bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="flex items-center mb-6 text-gray-600">
                            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <!-- Kepala -->
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6a3 3 0 11-6 0 3 3 0 016 0z" />
                            <!-- Bahu & leher -->
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 20v-2a4 4 0 014-4h2" />
                            <!-- Gelombang suara dari mulut -->
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10c1 .5 1.5 1.5 1.5 2.5s-.5 2-1.5 2.5" />
                            </svg>
